    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, max_digits=8, validators=[django.core.validators.MinValueValidator(0.01)])),
                ('salePrice', models.DecimalField(decimal_places=2, max_digits=8, validators=[django.core.validators.MinValueValidator(0.01)])),
                ('dateFrom', models.DateTimeField()),
                ('dateTo', models.DateTimeField()),
                ('title', models.CharField(max_length=20)),
                ('images', models.ManyToManyField(related_name='product_sale_image', to='myshop.image')),
